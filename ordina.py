...
# La migliore e più aggiornata lista pubblica al mondo per l'Italia
...
def process_playlist():
    print("Scaricamento della lista iptv-org in corso...")
    ...
    # Scrive il file finale inserendo l'EPG
