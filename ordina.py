#!/usr/bin/env python3
# =====================================================================
#  ORDINA MAGINET SECONDO TIVUSAT
#  Scarica la playlist Maginet, assegna a ogni canale il numero LCN
#  Tivusat, riordina e salva il file. Solo Maginet, nessun'altra fonte.
...
# ----------------------------- CONFIG --------------------------------
MAGINET = "https://raw.githubusercontent.com/maginetweb-arch/TVITALIA/refs/heads/main/iptvit.m3u"
...
LCN_TIVUSAT = {
    ...
    "marcopolo": 55, "hgtv": 56, "hgtvitaly": 56,
    ...
    "radiomontecarlotv": 67, "virginradiotv": 68, "france24": 69,
...
def apply_tvgid(extinf, lcn):
    ...
    lascio quello eventualmente gia' presente in Maginet."""
...
def main():
    print(f"Scarico Maginet...")
    r = requests.get(MAGINET, headers=HEADERS, timeout=15)
    r.raise_for_status()
